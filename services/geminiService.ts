...
// FIX: Initialize GoogleGenAI with process.env.API_KEY as per guidelines. This resolves the TypeScript error with `import.meta.env`.
...
const responseSchema = {
    ...
    properties: {
        ...
        crossReferences: {
            type: Type.ARRAY,
            description: "Cross-references to other religious or historical texts that provide additional context or parallel perspectives.",
            items: {
                type: Type.OBJECT,
                properties: {
                    text: {
        ...
        historicalContext: {
            type: Type.STRING,
            description: "A paragraph explaining the historical, cultural, and linguistic context surrounding the user's question and the provided texts."
        }
    },
